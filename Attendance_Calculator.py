...
labelNum2 = tk.Label(root, text="Enter number of classes conducted").grid(row=2, column=0)
labelNum3 = tk.Label(root, text="Enter number of classes attended").grid(row=3, column=0)
...
buttonCal = tk.Button(root, text="Calculate Attendance", command=attendance.call_result).grid(row=5, column=0)
buttonCal1 = tk.Button(root, text="Calculate Bunks", command=bunk.call_result2).grid(row=7, column=0)
root.mainloop()
